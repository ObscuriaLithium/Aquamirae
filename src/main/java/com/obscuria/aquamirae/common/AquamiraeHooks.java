...
public interface AquamiraeHooks {
    static void onTooltip(ItemStack stack, List<Component> tooltip) {
        if (DeadSeaCurse.isCursed(stack)) tooltip.add(1,
                Component.translatable("lore.aquamirae.dead_sea_curse")
    ...
    static float onLivingHurt(LivingEntity entity, float amount, DamageSource source) {
    ...
    static boolean onPlayerBreathe(Player player, boolean origin) {
