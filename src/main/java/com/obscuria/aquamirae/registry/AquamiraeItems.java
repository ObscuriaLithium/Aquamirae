...
public class AquamiraeItems {
    ...
    public static final RegistryObject<Item> GOLDEN_MOTH_SPAWN_EGG = REGISTRY.register("golden_moth_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.GOLDEN_MOTH, -3381760, -205, new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> MAW_SPAWN_EGG = REGISTRY.register("maw_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.MAW, -16764109, -16737895, new Item.Properties()));
    public static final RegistryObject<Item> ANGLERFISH_SPAWN_EGG = REGISTRY.register("anglerfish_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.ANGLERFISH, -12963033, -4942746, new Item.Properties()));
    ...
    public static final RegistryObject<Item> MAZE_MOTHER_SPAWN_EGG = REGISTRY.register("maze_mother_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.MAZE_MOTHER, -10092442, -39169, new Item.Properties()));
    public static final RegistryObject<Item> CAPTAIN_CORNELIA_SPAWN_EGG = REGISTRY.register("captain_cornelia_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.CAPTAIN_CORNELIA, -7760229, -13355980, new Item.Properties().rarity(Rarity.EPIC)));
    ...
    public static final RegistryObject<Item> PILLAGERS_PATROL_SPAWN_EGG = REGISTRY.register("pillagers_patrol_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.PILLAGERS_PATROL, -16751002, -16711681, new Item.Properties()));
    public static final RegistryObject<Item> TORTURED_SOUL_SPAWN_EGG = REGISTRY.register("tortured_soul_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.TORTURED_SOUL, -13421773, -16724737, new Item.Properties()));
    ...
    public static final RegistryObject<Item> FROZEN_KEY = REGISTRY.register("frozen_key", () -> new Item(new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> EEL_SPAWN_EGG = REGISTRY.register("eel_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.EEL, -16764109, -16737844, new Item.Properties()));
    public static final RegistryObject<Item> SWEET_LANCE = REGISTRY.register("sweet_lance", SweetLanceItem::new);
    public static final RegistryObject<Item> SPINEFISH_SPAWN_EGG = REGISTRY.register("spinefish_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.SPINEFISH, 1589067, 11451069, new Item.Properties()));
    public static final RegistryObject<Item> ABYSSAL_SCYPHOID_SPAWN_EGG = REGISTRY.register("abyssal_scyphoid_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.ABYSSAL_SCYPHOID, -39169, -10092442, new Item.Properties()));
