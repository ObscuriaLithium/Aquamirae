...
public class AquamiraeItems {
	...
	public static final RegistryObject<Item> GOLDEN_MOTH_SPAWN_EGG = REGISTRY.register("golden_moth_spawn_egg",
			() -> new ForgeSpawnEggItem(AquamiraeEntities.GOLDEN_MOTH, -3381760, -205,
					new Item.Properties().rarity(Rarity.UNCOMMON).tab(AquamiraeMod.TAB)));
	...
	public static final RegistryObject<Item> MAW_SPAWN_EGG = REGISTRY.register("maw_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.MAW,
			-16764109, -16737895, new Item.Properties().tab(AquamiraeMod.TAB)));
	...
	public static final RegistryObject<Item> CAPTAIN_CORNELIA_SPAWN_EGG = REGISTRY.register("captain_cornelia_spawn_egg",
			() -> new ForgeSpawnEggItem(AquamiraeEntities.CAPTAIN_CORNELIA, -7760229, -13355980,
					new Item.Properties().rarity(Rarity.EPIC).tab(AquamiraeMod.TAB)));
	...
	public static final RegistryObject<Item> EEL_SPAWN_EGG = REGISTRY.register("eel_spawn_egg", () -> new ForgeSpawnEggItem(AquamiraeEntities.EEL,
			-16764109, -16737844, new Item.Properties().tab(AquamiraeMod.TAB)));
	...
	public static final RegistryObject<Item> PAINTING_ANGLERFISH = block(AquamiraeBlocks.PAINTING_ANGLERFISH, new Item.Properties().tab(AquamiraeMod.TAB).rarity(Rarity.UNCOMMON));
	public static final RegistryObject<Item> PAINTING_OXYGELIUM = block(AquamiraeBlocks.PAINTING_OXYGELIUM, new Item.Properties().tab(AquamiraeMod.TAB).rarity(Rarity.UNCOMMON));
	public static final RegistryObject<Item> PAINTING_TORTURED_SOUL = block(AquamiraeBlocks.PAINTING_TORTURED_SOUL, new Item.Properties().tab(AquamiraeMod.TAB).rarity(Rarity.UNCOMMON));
	public static final RegistryObject<Item> PAINTING_AURORA = block(AquamiraeBlocks.PAINTING_AURORA, new Item.Properties().tab(AquamiraeMod.TAB).rarity(Rarity.UNCOMMON));
	public static final RegistryObject<Item> GOLDEN_MOTH_IN_A_JAR = block(AquamiraeBlocks.GOLDEN_MOTH_IN_A_JAR, new Item.Properties().tab(AquamiraeMod.TAB));
	...
	public static final RegistryObject<Item> OXYGEN_TANK = REGISTRY.register("oxygen_tank",
			() -> new Item(new Item.Properties().tab(AquamiraeMod.TAB).stacksTo(1).rarity(Rarity.COMMON)));
	public static final RegistryObject<Item> FROZEN_CHEST = block(AquamiraeBlocks.FROZEN_CHEST, new Item.Properties().tab(AquamiraeMod.TAB).rarity(Rarity.UNCOMMON));
