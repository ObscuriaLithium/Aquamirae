...
//                    new MobEffectInstance(MobEffects.CONFUSION, 400, 1, false, true)));
    public static final RegistryObject<Potion> POISON_IMMUNITY = REGISTRY.register("poison_immunity",
            () -> new Potion(
                    new MobEffectInstance(AquamiraeMobEffects.POISON_IMMUNITY.get(), 3600)));
    public static final RegistryObject<Potion> LONG_POISON_IMMUNITY = REGISTRY.register("long_poison_immunity",
            () -> new Potion("poison_immunity",
                    new MobEffectInstance(AquamiraeMobEffects.POISON_IMMUNITY.get(), 9600)));
}
