...
public class IceMazeArchFeature extends Structure<NoFeatureConfig> {
   ...
   public  IStartFactory<NoFeatureConfig> getStartFactory() {
      return IceMazeArchFeature.Start::new;
   }
   ...
   private static final List<MobSpawnInfo.Spawners> STRUCTURE_CREATURES = ImmutableList.of(
           new MobSpawnInfo.Spawners(AquamiraeEntities.GOLDEN_MOTH.get(), 100, 1, 3)
   );
