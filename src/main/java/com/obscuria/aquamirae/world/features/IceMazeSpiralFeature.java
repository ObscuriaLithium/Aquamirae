...
public class IceMazeSpiralFeature extends StructureFeature<JigsawConfiguration> {
   ...
   public IceMazeSpiralFeature() {
      super(CODEC, IceMazeSpiralFeature::createPiecesGenerator, PostPlacementProcessor.NONE);
   }
   ...
   public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
      if (!IceMazeSpiralFeature.isFeatureChunk(context)) {
