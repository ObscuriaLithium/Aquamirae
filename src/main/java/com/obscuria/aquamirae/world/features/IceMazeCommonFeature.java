...
public class IceMazeCommonFeature extends StructureFeature<JigsawConfiguration> {
   ...
   public IceMazeCommonFeature() {
      super(CODEC, IceMazeCommonFeature::createPiecesGenerator, PostPlacementProcessor.NONE);
   }
   ...
   public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
      if (!IceMazeCommonFeature.isFeatureChunk(context)) {
         return Optional.empty();
      }
      BlockPos blockpos = context.chunkPos().getMiddleBlockPosition(0);
      blockpos = blockpos.below(11);
