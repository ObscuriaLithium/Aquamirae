...
@OnlyIn(Dist.CLIENT)
public class TerribleArmorExtension implements IClientItemExtensions {
    @NotNull
    @Override
    public HumanoidModel<? extends LivingEntity> getHumanoidArmorModel(LivingEntity entity, ItemStack stack,
        ...
        final var armor = new ModelTerribleArmor<>(Minecraft.getInstance()
                .getEntityModels().bakeLayer(AquamiraeLayers.TERRIBLE_ARMOR));
